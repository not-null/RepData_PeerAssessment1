...
We can say that, <span style="color:red;">`r five.steps$interval`</span> 5-minute interval has maximum steps of <span style="color:red;">`r five.steps$steps`</span>.
...
Everyday at <span style="color:red;">`r t`</span>, we have maximum number of steps.
...
Original has <span style="color:red;">`r len.orig`</span> NA values and modified has <span style="color:red;">`r len.modified`</span> NA values.
...
---------       |   ---------       |   ---------       |   ---------
`r new.mean`    |   `r old.mean`    |   `r new.median`  |   `r old.median`
